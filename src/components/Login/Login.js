...
function Login() {
  ...
  return (
    <form className="App-login">
      ...
      <a href="http://lucasferreiralimax-dev.web.app">Esqueceu seu e-mail?</a>
      <p>Não está no seu computador? Use o modo visitante para fazer login com privacidade. <a href="http://lucasferreiralimax-dev.web.app">Saiba mais</a></p>
