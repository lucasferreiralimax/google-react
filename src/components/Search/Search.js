...
function Search({ store, dispatch }) {
  ...
  const twoL = () => {
    ...
    alert(t('text.2L_search'));
  };

  const doisL = () => { alert(t('text.2L_lucky')); };
    ...
    <section data-testid="app-search" className="App-search">
      <label className="label-search">
        ...
        <input
          ...
          placeholder={t('search_component.search_label')}
      ...
      <button
        ...
        type="button"
      >
        <img src={keyboard} className="icon-keyboard" alt={t('search_component.alt_keyboard')} width="19" height="11" />
